...
<body>
    ...
    <div class="hero-container">
        <img src="/assets/hero_dairy.jpg" style="width:100%;">
        <div class="centered">
            <h1 style="font-size: 100px;">Dairy</h1>
        </div>
    </div> 
    <div class="container">
        ...
        <div class="row container-fluid pt-2 py-2">
            ...
            <div class="col-sm-4 text-center">
            <?php $key = 1 + array_search("Gouda", array_column($products, 'name')); ?>
                <?php $discount = number_format($products[$key]['price'] * (1 - $products[$key]['promo_amt']), "2"); ?>
                <a href="<?php echo $products[$key]['file']; ?>">
                    <img class="img-fluid pb-3" style="width:75%;" src="<?php echo $products[$key]['image']; ?>"/>
                    <h5 style="text-transform: uppercase;"><?php echo $products[$key]['name']; ?></h5>
        ...
        <div class="row container-fluid pt-2 py-2">
            <div class="col-sm-4 text-center">
            <?php $key = 1 + array_search("Parmesan", array_column($products, 'name')); ?>
                <?php $discount = number_format($products[$key]['price'] * (1 - $products[$key]['promo_amt']), "2"); ?>
                <a href="<?php echo $products[$key]['file']; ?>">
                    <img class="img-fluid pb-3" style="width:75%;" src="<?php echo $products[$key]['image']; ?>"/>
                    <h5 style="text-transform: uppercase;"><?php echo $products[$key]['name']; ?></h5>
            ...
            <div class="col-sm-4 text-center">
            <?php $key = 1 + array_search("White Cheddar", array_column($products, 'name')); ?>
                <?php $discount = number_format($products[$key]['price'] * (1 - $products[$key]['promo_amt']), "2"); ?>
                <a href="<?php echo $products[$key]['file']; ?>">
                    <img class="img-fluid pb-3" style="width:75%;" src="<?php echo $products[$key]['image']; ?>"/>
                    <h5 style="text-transform: uppercase;"><?php echo $products[$key]['name']; ?></h5>
            ...
            <div class="col-sm-4 text-center">
            <?php $key = 1 + array_search("Yogurt", array_column($products, 'name')); ?>
                <?php $discount = number_format($products[$key]['price'] * (1 - $products[$key]['promo_amt']), "2"); ?>
                <a href="<?php echo $products[$key]['file']; ?>">
                    <img class="img-fluid pb-3" style="width:75%;" src="<?php echo $products[$key]['image']; ?>"/>
                    <h5 style="text-transform: uppercase;"><?php echo $products[$key]['name']; ?></h5>
        ...
        <div class="row container-fluid pt-2 py-2">
            ...
            <div class="col-sm-2 text-center">
                <div class="pagination py-5 center">
                    ...
                    <a href="dairy2.php">2</a>
                    <a href="dairy2.php">&raquo;</a>
                  </div> 
            </div>
            <div class="col-sm-5 text-center"></div>
        </div>
