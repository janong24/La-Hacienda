...
<body>
    ...
    <div class="hero-container">
        <img src="/assets/hero_chicken.jpg" style="width:100%;">
        <div class="centered">
            <h1 style="font-size: 100px;">Chicken</h1>
        </div>
    </div> 
    <div class="container">
        ...
        <div class="row container-fluid pt-2 py-2">
            <div class="col-sm-4 text-center">
                <?php $key = 1 + array_search("Whole Chicken", array_column($products, 'name')); ?>
            ...
            <div class="col-sm-4 text-center">
            <?php $key = 1 + array_search("Chicken Breast", array_column($products, 'name')); ?>
                <?php $discount = number_format($products[$key]['price'] * (1 - $products[$key]['promo_amt']), "2"); ?>
                <a href="<?php echo $products[$key]['file']; ?>">
                    <img class="img-fluid pb-3" style="width:75%;" src="<?php echo $products[$key]['image']; ?>"/>
                    <h5 style="text-transform: uppercase;"><?php echo $products[$key]['name']; ?></h5>
            ...
            <div class="col-sm-4 text-center">
                <?php $key = 1 + array_search("Chicken Thighs", array_column($products, 'name')); ?>
                <?php $discount = number_format($products[$key]['price'] * (1 - $products[$key]['promo_amt']), "2"); ?>
                <a href="<?php echo $products[$key]['file']; ?>">
                    <img class="img-fluid pb-3" style="width:75%;" src="<?php echo $products[$key]['image']; ?>"/>
                    <h5 style="text-transform: uppercase;"><?php echo $products[$key]['name']; ?></h5>
        ...
        <div class="row container-fluid pt-2 py-2">
            ...
            <?php $key = 1 + array_search("Chicken Drumstick", array_column($products, 'name')); ?>
                <?php $discount = number_format($products[$key]['price'] * (1 - $products[$key]['promo_amt']), "2"); ?>
                <a href="<?php echo $products[$key]['file']; ?>">
                    <img class="img-fluid pb-3" style="width:50%;" src="<?php echo $products[$key]['image']; ?>"/>
                    <h5 style="text-transform: uppercase;"><?php echo $products[$key]['name']; ?></h5>
                    <p><?php echo $products[$key]['vendor']; ?><br/>$<?php echo $discount; ?></p>
            </div>
            <div class="col-sm-6 text-center">
            <?php $key = 1 + array_search("Chicken Wings", array_column($products, 'name')); ?>
                <?php $discount = number_format($products[$key]['price'] * (1 - $products[$key]['promo_amt']), "2"); ?>
                <a href="<?php echo $products[$key]['file']; ?>">
                    <img class="img-fluid pb-3" style="width:50%;" src="<?php echo $products[$key]['image']; ?>"/>
                    <h5 style="text-transform: uppercase;"><?php echo $products[$key]['name']; ?></h5>
