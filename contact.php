...
<body>
    ...
    <div class="content-container">       
        ...
        <br />
        <form method="POST" action="contactVerify.php">
            <label for="email">E-Mail</label>
            <input type="text" id="email" name="email" placeholder="Your e-mail address..." required>
            
            <label for="order">Order #</label>
            <input type="text" id="order" name="order" placeholder="Your order number... (i.e. 12345AB)" 
            pattern="[0-9]{5}[A-Za-z]{2}" required>
        
            <input type="submit" value="Verify Order">
        </form>
    </div>
    <!--END CONTENT-->
