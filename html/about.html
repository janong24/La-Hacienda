...
<body>
    ...
    <!--CONTENT-->
    <div class="content-container" style="text-align: justify; text-justify: inter-word;">       
        <h1>ABOUT US</h1>
        <br />
        <p>La Hacienda delivers farm fresh organic food straight from the producer and onto your fork. All meat and produce sold is sustainably grown with utmost respect for animals and care for the future of our planet. La Hacienda is your local farmers market hooked up to the digital world, bringing you the freshest to your fingertips.</p>
        <br />
        <hr>
        <br />
        <p><b>DISCLAIMER:</b> This website is a mock-up and is not intended to sell anything online. This website was created to satisfy requirements set forth by SOEN287 - Web Programming, a subject under Concordia University's Software Engineering Program, under Prof. Quan Zixi. All images and assets were taken under the Creative Commons License.</p>
        <br />
        <p>Student Name: Jan Mikhail Alexei Ong</p>
        <p>Student ID: 40154849</p>
        <br />
    </div>
    <!--END CONTENT-->
