...
<body>
    ...
    <div class="content-container">       
        ...
        <form action="loginFunc.php" method="POST">
            ...
            <br/><br/>
            <div>
                <p><a href="register.html">No account yet? Register here.</a></p>
                <p><a href="forgotpw.html">Forgot your password?</a></p>
            </div>
            <hr />
        </form>
        <div>
                <form action="logout.php" method="POST">
                <input type="submit" name="logout" value="Logout of your account">
                </form>
            </div>
    </div>
    <!--END CONTENT-->
