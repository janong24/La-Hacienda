...
<body>
    ...
    <div class="container">
        ...
        <div class="row container-fluid pt-2 py-2">
            ...
            <?php $key = 1 + array_search("Skirt Steak", array_column($products, 'name')); ?>
        ...
        <div class="row container-fluid pt-2 py-2 justify-content-center">
                <div class="pagination py-5 center">
                    <a href="beef2.html">&laquo;</a>
                    <a href="beef.html">1</a>
                    <a href="beef2.html">2</a>
                    <a class="active"href="beef3.html">3</a>
                    <a href="#">&raquo;</a>
                  </div> 
        </div>
    </div>
